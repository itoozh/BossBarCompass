 ...
 *      /____/
 *
 * Copyright (C) SynPvP - All Rights Reserved
 * Unauthorized copying of this file, via any medium is strictly prohibited
 * Proprietary and confidential
 * Written by Ralph B <mcpe4life62@gmail.com>,  September 14, 2018
 *
 */
...
final class BossBar {
	...
	#[Pure] private function createBossEventPacket(int $eventType): BossEventPacket {
		...
		$pk->color = $pk->overlay = $pk->unknownShort = 0;
	...
	public function showTo(Player $player, bool $isViewer = true) {
		...
		$pk->position = $player->getPosition()->subtract(0, 28, 0); // spawn under the player
